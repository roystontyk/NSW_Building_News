...
from datetime import datetime, timedelta, timezone # AMENDED: Added for timezone control

# === CONFIG ===
TELEGRAM_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN")
CHAT_ID = os.getenv("TELEGRAM_CHAT_ID")

# Melbourne/Sydney Time Offset (UTC+11)
SYD_MELB_TZ = timezone(timedelta(hours=11))
...
def main():
    ...
    # --- AMENDED: Force Local NSW/VIC Date ---
    today_local = datetime.now(SYD_MELB_TZ).strftime('%d %b %Y')
